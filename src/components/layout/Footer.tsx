...
export default function Footer() {
  return (
    <footer className="bg-gradient-to-b from-slate-800 to-slate-900 pt-12 pb-8 md:pt-16">
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-8 md:gap-12 max-w-10/12 2xl:max-w-[63.33%] mx-auto">
                ...
                {listItems.map((item) => (
                  <li key={item}>
                    <Link
                      ...
                      className="text-gray-300 hover:text-primary transition-colors text-sm md:text-base block py-1 md:py-1.5"
                    >
                      {item}
                    </Link>
                  </li>
