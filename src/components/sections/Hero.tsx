...
export default function Hero() {
  return (
    <section className="relative top-24 md:top-0 min-h-screen flex flex-col md:flex-row grow-0 md:justify-between items-center max-w-10/12 2xl:max-w-9/12 mx-auto">
      <motion.div
